    ...
    <br>
     <?php
        ...
        if (mysqli_num_rows($results) == 0){
            echo "There are no challenges.<br>";
        }
        ...
        while ($index < $num_challenges) {
            ...
            if ($currDate1 >= $enddate1){
                ...
                $tmp_challenge_winnerID = $tmp_challenge_info['winnerUserID'];
                ...
                while ($u = mysqli_fetch_array($r)) {
                    ...
                    echo "<a href ='youraccount.php?view_username=$username_winner' style=\"color:#20b2aa\"> @$username_winner </a> <br>";
                }
                          echo "
        ...
        if ($expired_challenges == 0) {
                ...
                echo '<ul class="list-group list-group-flush">';
                echo '<li class="list-group-item border-0">';
                echo "There are no expired challenges to show.<br></li></ul></div></div>";
        }
