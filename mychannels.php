...
<body>
    ...
    <div class="border border-0 rounded-3 mb-5 bg-transparent">
        ...
        <?php
            ...
            $q = "SELECT * FROM Channel WHERE userID='$id'";
            $r = mysqli_query($db, $q);
            $count = 0;
            while ($channel = mysqli_fetch_array($r)) {
                ...
                // view channel button
                          ...
                          <div style=\"float: left; width: 130px\"> 
                                <form method=\"post\" action='viewchannel.php?channel=$channel_id' style='float: left;'>
                                    <input type=\"submit\" value=\"View Channel\" name=\"viewchannel\" class=\"btn btn-primary btn-sm\">
                                </form>
                            </div>
                            <div style=\"float: left; width: 130px\"> 
                                <form method=\"post\" action='adminchannel.php?channel=$channel_id '>
                                    <input type=\"submit\" value=\"Channel Settings\" name=\"channelsettings\" class=\"btn btn-primary btn-sm\">
                                </form><br>
                            </div>
                            ";
                echo '</li></ul></div></div>';
