...
<body style = "background-color:transparent">
    <?php include "includes/feedheader.html" ?> <!-- Calls the header file -->
    ...
    <?php
        ...
        if ($posts_count == 0) {
            ...
            echo '<li class="list-group-item  border-0 mb-2">';
            echo "There are no posts found for your feed.<br>";
            echo "Search for users to follow them to see their posts in your feed.";
            echo '</li></ul></div></div>';
        }
        ...
        while ($current_index < $posts_count) {
            ...
            echo "<center>";
            echo "<img src=\"$image_src\" style=\" border:2px solid black;\" class=\"card-img-top\"><br>";
            echo "</center>";
            echo '</li>';
            echo '<li class="list-group-item  border-0">';
            ...
            echo "<a><img src=\"images/globe.webp\" style=\"width:3%\"><img src=\"images/locationpin.png\" style=\"width:3%\">: $location</a>";
            echo '</li>';
            ...
            echo "<Comments:<br>";
            $comments_count = 0;
            $query_getcomments = "SELECT * FROM Comments WHERE postID='$post_id' LIMIT 3";
            ...
            echo "<form method=\"post\" class=\"d-flex\">
                ...
                <input type=\"submit\" value=\"Add Comment\" class=\"btn btn-primary btn-sm\" name=\"comment$current_index\">
                </form>";
            
            // button to view all comments
            echo "<br>
            <center><form method=\"post\" action='viewpost.php?post=$post_id'>
                        <input type=\"submit\" value=\"View Post\" class=\"btn btn-primary btn-sm\" name=\"viewPost\">
                    </center></form>";
